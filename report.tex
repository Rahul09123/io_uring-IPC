...
64\,KiB, versus 5.07\,GiB/s for POSIX pipe.  This result is consistent with
avoiding a kernel-mediated payload copy on the shared-memory data path.
...
\begin{enumerate}
  ...
  \item \textbf{The 1\,MiB throughput inversion is consistent with ring depth.}
