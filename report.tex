...
this design choice: \texttt{busy\_poll} achieves 0.022\,$\mu$s wakeup latency
vs.\ 1092--1095\,$\mu$s for the interrupt-mode sleeping variants. The trade-off is
one dedicated core per media driver; for applications that can afford this,
it provides the lowest measured wakeup latency on this platform.
