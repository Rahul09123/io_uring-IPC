...
\begin{table}[H]
  \centering
  \caption{Single-Trip Ping-Pong Latency Distributions ($\mu$s). Full distributions (P90, P99.9, mean $\pm$ 95\% CI) are reported for 64\,B and 4\,KiB where the 100,000-trip raw sample was retained; 64\,KiB and 1\,MiB report P50\,/\,P99 only (see Threat~7).}
  \label{tab:pingpong}
  \small
  \begin{tabular}{@{}lrrrrr@{}}
    ...
    \texttt{shm (adaptive)}   & 0.213          & 0.280 & 0.582 & 1.807 & 0.233 $\pm$ 0.002 \\
