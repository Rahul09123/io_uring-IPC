...
\title{How Much Does Interrupt-Mode io\_uring Help Shared-Memory IPC?\\
...
\author{
  ...
  \and
  \IEEEauthorblockN{B. Thangaraju}
  \IEEEauthorblockA{\textit{Dept. of Computer Science and Engineering}\\
  \textit{IIIT Bangalore}, India\\
  Email: b.thangaraju@iiitb.ac.in}
}
...
213--218\,ns at 64\,B---a 15$\times$ improvement over pipe or
socket---and peak streaming throughput of 27.88\,GiB/s at 64\,KiB.
In depth-1 ping-pong tests (Suite 2), io\_uring incurs a modest per-event
ring submission overhead (+1.3\,$\mu$s over futex/eventfd at 64\,B).
...
io\_uring's key architectural advantage lies in providing a unified,
